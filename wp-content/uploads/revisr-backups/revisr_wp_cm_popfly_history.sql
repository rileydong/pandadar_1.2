...
DROP TABLE IF EXISTS `wp_cm_popfly_history`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `wp_cm_popfly_history` (
...
LOCK TABLES `wp_cm_popfly_history` WRITE;
/*!40000 ALTER TABLE `wp_cm_popfly_history` DISABLE KEYS */;
/*!40000 ALTER TABLE `wp_cm_popfly_history` ENABLE KEYS */;
UNLOCK TABLES;
