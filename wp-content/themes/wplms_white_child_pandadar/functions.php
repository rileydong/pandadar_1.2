...
define('VIBE_CHILD_PATH',get_theme_root().'/wplms_white_child_pandadar');
...
/*Try to fix the permalink issue that does not resolve by resaving*/
function flush_rules(){
flush_rewrite_rules();
}
add_action('init','flush_rules');

/*Added especial for Pandadar*/
/*Enable shortcodes as widget*/
add_filter('widget_text', 'do_shortcode');

/*this is to recover site when changing url cause site down.*/
//update_option( 'siteurl', 'http://192.241.173.232/wordpress');
//update_option( 'home', 'http://192.241.173.232/wordpress');
