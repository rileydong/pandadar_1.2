	...
	public function about_screen() {
		...
		<div class="wrap wplms-wrap about-wrap">
			...
			<div class="changelog">
				<div class="wplms-feature feature-rest feature-section col two-col">
					<div class="col-1">
						<h4><?php _e( '21 bug fixes & updates', 'vibe' ); ?></h4>
						<p><?php _e( 'We\'ve fixed some pending bugs. A lot of pending issues, style issues have been fixed.', 'vibe' ); ?></p>
						<a href="http://vibethemes.com/documentation/wplms/knowledge-base/2-0-7/" class="button"><?php _e( 'Check update log ', 'vibe' ); ?></a>
					</div>
					<div class="col-2">
						<h4><?php _e( 'Bug fixes Update', 'vibe' ); ?></h4>
						<p><?php _e( 'A lot of bugs have been fixed. We\'ve fixed most of the issues reported by the users.', 'vibe' ); ?></p>
						<a href="http://vibethemes.com/documentation/wplms/knowledge-base/2-0-7/" class="button"><?php _e( 'Check update log ', 'vibe' ); ?></a>
					</div>
				</div>
			</div>
			<div class="changelog about-integrations">
				...
				<div class="wplms-feature feature-section col three-col">
					<div>
						<h4><?php _e( 'Improved Certficates', 'vibe' ); ?></h4>
						<p><img src="<?php echo VIBE_URL.'/setup/data/uploads/new/certificate.png'; ?>" /></p>
					</div>
					<div>
						<h4><?php _e( 'One Page/ChildOne/Modern Theme Update', 'vibe' ); ?></h4>
						<p><img src="<?php echo VIBE_URL.'/setup/data/uploads/new/modern.png'; ?>" /></p>
					</div>
					<div class="last-feature">
						<h4><?php _e( 'RTL Styling updated', 'vibe' ); ?></h4>
						<p><img src="<?php echo VIBE_URL.'/setup/data/uploads/new/rtl.png'; ?>" /></p>
					</div>
				</div>
			</div>
			<div class="changelog">
				<div class="feature-section col three-col">
					<div>
						<h4><?php _e( 'WPLMS BadgeOS plugin', 'vibe' ); ?></h4>
						<p><?php _e( 'WPLMS BadgeOS plugin now supports marks ranges. Previously you could only award badges for marks greater than, now you can award badges for marks less than and between ranges as well.', 'vibe' ); ?></p>
					...
					<div class="last-feature">
						...
						<a href="http://vibethemes.com/documentation/wplms/knowledge-base/2-0-6-1/"><?php _e( 'Check Translation files status','vibe'); ?></a>
					</div>
				</div>
			</div>
			<div class="return-to-dashboard">
