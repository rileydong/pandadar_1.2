...
jQuery(document).ready(function($){  
  ...
  if($('header.sleek').hasClass('transparent')){
      ...
      if($('body').hasClass('page-template-contact-php')){
        ...
        next = $('#item-header');
          ...
          next = $('#item-header');
      }else if(($('body').hasClass('single-course') && ( $('body').hasClass('c2') || $('body').hasClass('c3') )) || ($('body').hasClass('single-course') && $('body').hasClass('modern-theme') && !$('body').hasClass('c4'))){
        next = $('#item-header');
      }else{
          next = header.next();
          if(!next.is(":visible")){
  ...
  if(!$('body').hasClass('modern-theme')){ 
    $('.bp-user.p2 #object-nav,.bp-user.p3 #object-nav,.bp-user.p4 #object-nav,
      .single-items.groups #object-nav,.single-course.c2 #object-nav,.single-course.c3 #object-nav,
      .single-course.c4 #object-nav,.single-course.c5 #object-nav').each(function(){
