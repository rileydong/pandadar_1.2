...
class WPLMS_Init{
    ...
    function activity_filters() {
        $activity_filters =array(
            ...
            'start_assignment' => __( 'Start Assignment', 'vibe' ),
            'submit_assignment' => __( 'Submit Assignment', 'vibe' ),
            'assignment_evaluated' => __( 'Assignment Evaluated', 'vibe' ),
        );
...
function register_required_plugins() {
    ...
    $plugins = array(
        array(
            ...
            'source'                => 'https://downloads.wordpress.org/plugin/buddypress.2.4.3.zip', // The plugin source
        ...
        array(
            ...
            'source'                => 'https://downloads.wordpress.org/plugin/woocommerce.2.5.3.zip', // The plugin source
        ...
        array(
            ...
            'source'                => 'https://downloads.wordpress.org/plugin/bp-social-connect.1.3.zip', // The plugin source
            'required'              => false, // If false, the plugin is only 'recommended' instead of required
