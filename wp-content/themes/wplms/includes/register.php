...
class WPLMS_Register{
    ...
    private function __construct(){
        ...
        // WP Admin access
        add_action('admin_init',array($this,'wp_admin_access'));
    ...
    function wplms_enqueue_admin($hook){ 
      ...
      if(in_array($hook,array('post.php','post-new.php','edit.php','toplevel_page_wplms_options','dashboard_page_wplms-install','lms_page_lms-settings','lms_page_lms-stats'))){
        ...
        wp_enqueue_style( 'admin-css', VIBE_URL .'/assets/css/old_files/admin.css' );
        wp_enqueue_script( 'admin-js', VIBE_URL .'/assets/js/old_files/vibe_admin.js',array('jquery','jquery-ui-datepicker'));
      }

      if($hook == 'nav-menus.php'){
          wp_enqueue_style( 'wplms-menu-css', VIBE_URL .'/includes/menu/css/admin_menu.css' );
          wp_enqueue_script( 'wplms-menu-js', VIBE_URL .'/includes/menu/js/admin_vibe_menu.js');
      }
    ...
    function wplms_enqueue_footer() {
        if(!is_admin()){ 
          ...
          if(function_exists('bp_is_active')){
            wp_enqueue_script( 'buddypress-js', VIBE_URL .'/assets/js/old_files/buddypress.js',array('jquery'),'2.0');
          }
          ...
          wp_enqueue_script( 'wplms', VIBE_URL.'/assets/js/wplms.min.js');
