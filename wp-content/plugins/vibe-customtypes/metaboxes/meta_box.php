...
class custom_add_meta_box {
    ...
    public function __construct( $id, $title, $fields, $page, $js ) {
        ...
        add_action( 'admin_print_styles-post-new.php',  array( $this, 'admin_enqueue_styles' ),100 ); 
        add_action( 'admin_print_styles-post.php',  array( $this, 'admin_enqueue_styles' ),100);
