...
class WBK_Backend_Services extends WBK_Backend_Component   {
    ...
    public function ajaxServiceEdit() {
        ...
        $resarray = array( 'id' => $service_id, 'name' => $name, 'desc' =>  $desc, 'email' => $email, 'duration' => $duration, 'step' => $step, 'interval' => $interval, 'users' => $users, 'form' => $form , 'bh' => $bh,  'quantity' => $quantity  );
    ...
    public function ajaxServiceLoad() {
        ...
        $resarray = array( 'name' => $name, 'desc' =>  $desc, 'email' => $email, 'duration' => $duration, 'step' => $step, 'interval' => $interval, 'users' => $users, 'form' => $form,'bh' => $bh, 'quantity' => $quantity );
