        ...
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
            ...
            <div id="wcs3-schedule-buttons-wrapper">
                <input id="wcs3-submit-item" type="submit" class="button-primary"
                       value="<?php _e('Add Item', 'wcs3'); ?>" name="wcs3-submit-item"/>
                <span class="wcs3-ajax-loader"><img src="<?php echo WCS3_PLUGIN_URL . '/img/loader.gif'; ?>"
...
{ ?>
    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
        <div id="wcs3-import-update-wrapper" class="wrap">
            ...
            <p>
                <strong><?php _e('WARNING:') ?></strong> <?php _e('All data added after updating to version 3 will be deleted.'); ?>
            </p>

            <input type="submit" name="wcs3_import_wcs2_data" id="wcs3_import_wcs2_data" class="button-primary"
                   value="<?php _e('Import/Update', 'wcs3'); ?>">
            <span class="wcs3-ajax-loader"><img src="<?php echo WCS3_PLUGIN_URL . '/img/loader.gif'; ?>"
                                                alt="Ajax Loader"/></span>
