...
class points_awarding_system {
	...
	function badges_earned($point_criteria_id,$id,$info=NULL,$user_id,$module,$total_usage,$user_specific_usage){
		$value = get_post_meta($point_criteria_id,'value',true);
		if(is_array($info)){
			$count = count($info);
			$module_score = get_post_meta($point_criteria_id,'wplms_module_score',true);
	...
	function certificates_earned($point_criteria_id,$id,$info=NULL,$user_id,$module,$total_usage,$user_specific_usage){
		$value = get_post_meta($point_criteria_id,'value',true);
