...
if (!defined( 'BUDDYPRESS_LEARNDASH_PLUGIN_VERSION' ) ) {
  define( 'BUDDYPRESS_LEARNDASH_PLUGIN_VERSION', '1.0.7' );
}
...
function buddypress_learndash_install_notice() {
    ...
    _e('<strong>BuddyPress for LearnDash</strong> requires the LearnDash and BuddyPress plugins to work. Please intall <a href="http://www.learndash.com/" target="_blank">LearnDash</a> and <a href="https://buddypress.org/" target="_blank">BuddyPress</a> first.', 'boss-learndash');
    echo '</p></div>';
}
...
function buddypress_learndash_upgrade_notice() {
    echo '<div id="message" class="error fade"><p style="line-height: 150%">';
    _e('<strong>BuddyPress for LearnDash</strong> requires LearnDash v2.1.8 or higher to work. Please <a href="http://www.learndash.com/">update LearnDash</a> first.', 'boss-learndash');
    echo '</p></div>';
}
