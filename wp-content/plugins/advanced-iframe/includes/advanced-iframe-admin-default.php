...
<?php _e('Basic settings', 'advanced-iframe'); ?></h2>
    ...
    <p class="shortcode hide-print">
      ...
      <span> [advanced_iframe securitykey="<?php echo $devOptions['securitykey']; ?>"]</span>
