...
echo '<table class="form-table">';
    ...
    printTrueFalse(true,$devOptions, __('i-20-Support zoom on IE8', 'advanced-iframe'), 'iframe_zoom_ie8', __('Zoom on IE8 does require the browser detection. And the browser detection does need a lot of memory during processing. So by default the IE8 support of zoom is disabled. If you enable this and your system runs out of memory the plugin does automatically disable this support by creating a file called advanced-iframe-custom/browser-check-failed.txt. As long as this file does exist the IE8 support for zoom is disabled. Shortcode attribute: iframe_zoom_ie8="true" or iframe_zoom_ie8="false"', 'advanced-iframe'),'false');
